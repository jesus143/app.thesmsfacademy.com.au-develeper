...
add_filter( 'widget_tag_cloud_args', 'twentysixteen_widget_tag_cloud_args' );
 ...
 add_action("wp_head", 'tsd_adding_css');

 function tsd_adding_css() {
 	?> 
 		<link rel="stylesheet" type="text/css" href="http://localhost/Tim/app.thesmsfacademy.com.au/developer/wordpress/wp-content/plugins/tshirtdesigner/public/css/style.css">
